    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#F8F8F8] text-[#252525]">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-16">
          <div className="w-full max-w-sm bg-white border border-[#CFCFCF] rounded-2xl shadow-sm p-8 text-center">
            <div className="w-12 h-12 rounded-2xl bg-[#F8F8F8] flex items-center justify-center mx-auto mb-4">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#252525" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-sm text-[#7D7D7D]">
              We sent a confirmation link to <span className="text-[#252525] font-medium">{email}</span>.
              Click it to activate your account.
            </p>
            <p className="text-sm text-[#7D7D7D] mt-6">
              Already confirmed?{" "}
